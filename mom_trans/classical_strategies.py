...
def calc_net_returns(data: pd.DataFrame, list_basis_points: List[float], identifiers = None):
    ...
    for i in identifiers:
        ...
        transaction_costs =  scaled_position.diff().abs().fillna(0.0).to_frame().to_numpy()* cost #  should probably fill first with initial cost
...
def calc_daily_vol(daily_returns): # TODO calc_daily_vol
    return (
